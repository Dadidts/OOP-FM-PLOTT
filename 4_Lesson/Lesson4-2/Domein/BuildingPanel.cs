...
internal class BuildingPanel : Building
{
    //КОНСТРУКТОР   
    internal BuildingPanel(double heightBulid, double heightFloor, int apart, int floor, int apartFloor, int entrance, int apartFloorEntrance, bool landscaped, string street)
    {
